...
// APIClient manages communication with the VMware SD-WAN Orchestrator API v1 API v4.4.0
...
type APIClient struct {
	...
	//
	//	ClientDeviceApi *ClientDeviceApiService
	//
	//	CompositeRoleApi *CompositeRoleApiService
	//
	...
	//
	//	EnterpriseProxyApi *EnterpriseProxyApiService
	//
	//	EventApi *EventApiService
	//
	//	FirewallApi *FirewallApiService
	//
	//	FunctionalRoleApi *FunctionalRoleApiService
	//
	...
	//
	//	MspApi *MspApiService
	//
	//	NetworkApi *NetworkApiService
	//
	//	OperatorApi *OperatorApiService
	//
	//	OperatorUserApi *OperatorUserApiService
	//
	...
	//
	//	SystemPropertyApi *SystemPropertyApiService
	//
	//	UpdateApi *UpdateApiService
	//
	//	UserMaintenanceApi *UserMaintenanceApiService
	//
	//	VcoDiagnosticsApi *VcoDiagnosticsApiService
	//
	//	VcoInventoryApi *VcoInventoryApiService
	//
...
//		c.ConfigurationApi = (*ConfigurationApiService)(&c.common)
	...
	//	c.EnterpriseProxyApi = (*EnterpriseProxyApiService)(&c.common)
	//	c.EventApi = (*EventApiService)(&c.common)
	//	c.FirewallApi = (*FirewallApiService)(&c.common)
	//	c.FunctionalRoleApi = (*FunctionalRoleApiService)(&c.common)
	...
	//	c.OperatorUserApi = (*OperatorUserApiService)(&c.common)
	...
	//	c.SystemPropertyApi = (*SystemPropertyApiService)(&c.common)
	//	c.UpdateApi = (*UpdateApiService)(&c.common)
	//	c.UserMaintenanceApi = (*UserMaintenanceApiService)(&c.common)
	//	c.VcoDiagnosticsApi = (*VcoDiagnosticsApiService)(&c.common)
	//	c.VcoInventoryApi = (*VcoInventoryApiService)(&c.common)
